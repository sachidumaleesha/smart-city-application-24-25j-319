  ...
  return (
    <main className="container mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-5">
        <BinFillLevel binName="Paper Bin" distance={demoDistance} />
        <BinFillLevel binName="Plastic Bin" distance={demoDistance} />
        <BinFillLevel binName="Organic Bin" distance={demoDistance} />
        <BinFillLevel binName="Glass Bin" distance={demoDistance} />
      </div>
